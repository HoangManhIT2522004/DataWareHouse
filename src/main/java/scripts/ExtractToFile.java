...
public class ExtractToFile {
    ...
    public static void checkTodayExtractSuccess() {
        try {
            ...
            if (alreadyExtracted[0]) {
                ...
                String body = "Hệ thống phát hiện hôm nay đã thực hiện extract thành công.\n\n" +
    ...
    /**
     * ============================================================
     * Step 4: Lấy/Tạo config và tạo log mới
     * ============================================================
     */
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            LoadConfig extractConfig = loadConfig("D:\\DataWareHouse\\src\\main\\java\\scripts\\extract_config.xml");
